...
function createResourceAndSetProperties(config, href, properties, setProperties) {
  ...
  return (0, _createResource2.default)(config, href, plainPropertiesForEmbeddedResource).then(function (createdEmbeddedResource) {
