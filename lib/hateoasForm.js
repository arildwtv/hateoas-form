(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["hateoasForm"] = factory(require("react"));
	else
		root["hateoasForm"] = factory(root["_"]);
...
var _fetchResource = __webpack_require__(21);

var _fetchResource2 = _interopRequireDefault(_fetchResource);

var _setProperty = __webpack_require__(22);

var _setProperty2 = _interopRequireDefault(_setProperty);

var _setProperties = __webpack_require__(11);
...
exports.default = {
  hateoasFormShape: _propTypes2.default.shape({
...
exports.HateoasProvider = exports.stripEmbeddings = exports.getLinkHref = exports.createHateoasComponent = undefined;

var _createHateoasComponent = __webpack_require__(19);
...
var _getLinkHref = __webpack_require__(54);

Object.defineProperty(exports, 'getLinkHref', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_getLinkHref).default;
  }
});

var _stripEmbeddings = __webpack_require__(15);
...
var _HateoasProvider = __webpack_require__(55);

Object.defineProperty(exports, 'HateoasProvider', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_HateoasProvider).default;
  }
});

var _hateoasForm = __webpack_require__(10);
...
var _stripLinks = __webpack_require__(46);

var _stripLinks2 = _interopRequireDefault(_stripLinks);
...
function _patch(filter, key, value) {
  ...
  this.hateoasForm.setProperty(this.state.resource, key, filter(value)).then(function (resource) {
...
function _patchAll(properties) {
  ...
  this.setState({ updating: true });
  this.hateoasForm.setProperties(this.state.resource, properties).then(function (resource) {
    return _this2.setState({ resource: resource, updating: false });
  });
}
...
function _patchFromEvent(filter, event) {
  _patch.call(this, filter, event.target.name, _parseValueFromEvent(event));
};

var contextTypes = {
  hateoasForm: _propTypes2.default.hateoasFormShape
};

function createHateoasComponent(config) {
  return function (Component) {
    var HateoasComponent = function (_React$Component) {
      _inherits(HateoasComponent, _React$Component);

      function HateoasComponent(props, context) {
        _classCallCheck(this, HateoasComponent);

        var _this3 = _possibleConstructorReturn(this, (HateoasComponent.__proto__ || Object.getPrototypeOf(HateoasComponent)).call(this, props));

        _this3.state = { resource: null, links: [], fetching: true };
        _this3.hateoasForm = props.hateoasForm || context.hateoasForm;

        var displayName = Component.displayName;


        (0, _invariant2.default)(_this3.hateoasForm, 'Could not find hateoasForm in either the context or props of ' + displayName + '. ' + 'Either wrap the root element in a <HateoasProvider>, ' + ('or explicitly pass hateoasForm as a prop to ' + displayName));

        _this3.patch = _patch.bind(_this3, function (value) {
          return value;
        });
        _this3.patchAll = _patchAll.bind(_this3);
        _this3.patchBooleanInput = _patchFromEvent.bind(_this3, function (value) {
          return ['1', 'true', true, 1].indexOf(value) > -1;
        });
        _this3.patchNumberInput = _patchFromEvent.bind(_this3, function (value) {
          return parseInt(value, 10);
        });
        _this3.patchInput = _patchFromEvent.bind(_this3, function (value) {
          return value;
        });
        return _this3;
      }
      ...
      _createClass(HateoasComponent, [{
        ...
        value: function fetchResource(props) {
          ...
          var url = config && config.resolveUrl ? config.resolveUrl(props, this.hateoasForm.fetchResource) : props.url;

          ((0, _isPromise2.default)(url) ? url : Promise.resolve(url)).then(function (url) {
            return _this4.hateoasForm.fetchResource(url);
          }).then(function (resource) {
            _this4.setState({ resource: resource, fetching: false });
          });
        }
      }, {
        key: 'render',
        value: function render() {
          var resource = (0, _stripEmbeddings2.default)(this.state.resource);
          return _react2.default.createElement(Component, _extends({}, this.props, {
            rawResource: this.state.resource,
            resource: resource,
            resourceFormValues: (0, _stripLinks2.default)(resource),
            patch: this.patch,
...
var _handleFetch = __webpack_require__(1);
...
function setProperty(context, resource, property, value) {
  return (0, _setProperties2.default)(context, resource, (0, _lodash2.default)({}, property, value));
};
...
function updateResource(context, resource, properties) {
  ...
  var selfHref = (0, _lodash4.default)(resource, '_links.self.href');
  context.emitter.emitUpdating(selfHref);

  try {
    return (0, _handleFetch2.default)(_fetch, selfHref, {
      method: 'PATCH',
      headers: {
...
function getEmbeddedResource(context, resource, embeddedName) {
  var _fetch = context.config.fetch || fetch;
...
var _createResource = __webpack_require__(27);
...
function createResource(context, href, properties) {
  var _fetch = context.config.fetch || fetch;
  ...
  return (0, _handleFetch2.default)(_fetch, href, {
    ...
    if (response.status === 201) {
      return (0, _handleFetch2.default)(_fetch, response.headers.get('Location'), {
        headers: {
          'Content-Type': 'application/json'
        }
      });
...
var stripLinks = function stripLinks(resource) {
  if (!resource) {
    return resource;
  }
  ...
  if ((0, _lodash2.default)(resource)) {
    var _links = resource._links,
        restProperties = _objectWithoutProperties(resource, ['_links']);

    return (0, _lodash4.default)(restProperties, function (property) {
      return stripLinks(property);
    });
  }
...
function getLinkHref(link) {
  ...
  var interpolatedHref = Object.keys(args).reduce(function (acc, argName) {
    return acc.replace(new RegExp('\\{\\?' + argName + '}', 'g'), '/' + args[argName]).replace(new RegExp('\\{' + argName + '}', 'g'), args[argName]);
  }, link.href);
...
var HateoasFormProvider = function (_React$Component) {
  _inherits(HateoasFormProvider, _React$Component);

  _createClass(HateoasFormProvider, [{
    key: 'getChildContext',
  ...
  function HateoasFormProvider(props, context) {
    _classCallCheck(this, HateoasFormProvider);

    var _this = _possibleConstructorReturn(this, (HateoasFormProvider.__proto__ || Object.getPrototypeOf(HateoasFormProvider)).call(this, props, context));

    _this.hateoasForm = props.hateoasForm;
    return _this;
  }
...
exports.default = HateoasFormProvider;
