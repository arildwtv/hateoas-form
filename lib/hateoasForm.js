...
exports.HateoasProvider = exports.stripEmbeddings = exports.createHateoasComponent = undefined;
...
var _HateoasProvider = __webpack_require__(53);
    ...
    var HateoasComponent = function (_React$Component) {
      ...
      _createClass(HateoasComponent, [{
        ...
        value: function fetchResource(props) {
          ...
          this.hateoasForm.fetchResource(props.url || config.url).then(function (resource) {
